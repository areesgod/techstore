...
Диссертация состоит из введения, восьми глав, заключения, списка литературы (49 источников) и приложений. Общий объём --- 95--115 страниц.
...
\begin{itemize}
  \item FR-06: Отображение 30 товаров (15 цифровых + 15 физических)
  \item FR-07: Фильтрация по категории и диапазону цен через боковую панель
...
\begin{enumerate}
  ...
  \item Все 27 функциональных требований выполнены; p95 времени ответа --- 287 мс.
